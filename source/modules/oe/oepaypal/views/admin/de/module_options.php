...
$aLang = array(
    ...
    'HELP_SHOP_MODULE_sOEPayPalBrandName'                    => 'Trage hier den Namen Deines Shops ein, der auf der PayPal-Zahlungsseite angezeigt werden soll.',
    'SHOP_MODULE_sOEPayPalBorderColor'                       => 'Warenkorbumrandungsfarbe für die PayPal-Zahlungsseite',
    'HELP_SHOP_MODULE_sOEPayPalBorderColor'                  => 'Trage hier den hexadezimalen Code der Farbe ein, die bei der Anzeige der PayPal-Zahlungsseite verwendet werden soll.',
    ...
    'HELP_SHOP_MODULE_sOEPayPalLogoImageOption'              => 'Auf der PayPal-Zahlungsseite kann ein Shop-Logo angezeigt werden. Es ist möglich, das Standard-Shop-Logo zu verwenden, welches in der Konfigurationsdatei des Shops definiert ist, oder ein spezielles Shop-Logo. Das Logo sollte nicht größer als 190px*60px (Breite*Höhe) sein. Größere Bilder werden an diese Breite und Höhe angepasst und deren Dateinamen mit einem Prefix "resized_" versehen. Für jedes verwendete Theme muss die Datei mit dem Logo im Verzeichnis /out/{theme}/img vorhanden sein. Wird das vorgesehene Logo nicht angezeigt, überprüfe bitte, ob der Dateiname korrekt angegeben wurde und die Datei im Verzeichnis existiert. Für das Standard-Shop-Logo überprüfe den Eintrag "sShopLogo" in der Datei config.inc.php. Füge diesen Eintrag hinzu, wenn dieser nicht vorhanden ist.',

    'SHOP_MODULE_sOEPayPalCustomShopLogoImage'               => 'Spezielles Shop-Logo für die PayPal-Zahlungsseite',
    'HELP_SHOP_MODULE_sOEPayPalCustomShopLogoImage'          => 'Auf der PayPal-Zahlungsseite kann ein eigenes Shop-Logo angezeigt werden. Speichere das Logo im Bildverzeichnis des Shops (/out/{theme}/img) und trage den Dateinamen hier ein. Für jedes verwendete Theme muss die Datei mit dem Logo im jeweiligen Verzeichnis vorhanden sein.',
    ...
    'HELP_SHOP_MODULE_sOEPayPalTransactionMode'              => 'Wähle aus, zu welchem Zeitpunkt der Geldtransfer stattfinden soll. Du hast die Möglichkeit, den Einzug des Geldes auf der PayPal-Seite sofort beim Kauf (SALE), oder erst unmittelbar vor Versand der Ware manuell durchzuführen (AUTH). Du kannst auch festlegen, dass der Zeitpunkt des Geldtransfers in Abhängigkeit vom Lagerbestand der bestellten Artikel vom Shop automatisch bestimmt wird (AUTOMATIC).',
    ...
    'HELP_SHOP_MODULE_sOEPayPalUsername'                     => 'Logge Dich in Dein <a target="_blank" href="https://www.paypal.com/de/cgi-bin/webscr?cmd=_get-api-signature&generic-flow=true">PayPal-Konto</a> ein, um Deine API-Signatur zu erhalten.',
    ...
    'HELP_SHOP_MODULE_sOEPayPalSandboxUsername'              => 'Logge Dich in Dein <a target="_blank" href="https://www.sandbox.paypal.com/de/cgi-bin/webscr?cmd=_get-api-signature&generic-flow=true">PayPal-Konto</a> ein, um Deine API-Signatur für die PayPal-Sandbox zu erhalten.',
