...
$aLang = array(
    ...
    'OEPAYPAL_ERROR_USER_ADDRESS'                => 'Deine im Shop hinterlegten Adressinformationen stimmen nicht mit Deiner PayPal-Lieferadresse überein. Aus Sicherheitsgründen müssen wir Deine Identität prüfen. Bitte logge Dich im Shop ein und führe den PayPal Express Checkout noch einmal durch.',
    ...
    'OEPAYPAL_PAYMENT_NOSHIPPINGFOUND'           => 'Keine Versandarten gefunden. Bitte kontaktiere uns telefonisch oder per E-Mail.',
    'OEPAYPAL_PAYMENT_NOT_VALID'                 => 'Leider kannst Du diese Artikel nicht mit PayPal zahlen. Bitte wähle eine andere Zahlungsart.',
    ...
    'OEPAYPAL_ORDER_ERROR'                       => 'Fehler im Bestellvorgang. Bitte versuche es später erneut oder wähle eine andere Zahlungsart.',
    'OEPAYPAL_RESPONSE_FROM_PAYPAL'              => 'Fehlermeldung von PayPal: ',
    'OEPAYPAL_ORDER_TOTAL_HAS_CHANGED'           => 'Auf Grund Deiner Auswahl im PayPal Express Checkout hat sich die Bestellsumme geändert. Bitte prüfe Deinen Warenkorb und fahre fort. Hinweis: Um den Express Checkout fortzusetzen, drücke den Express Checkout Button erneut.',
    ...
    'OEPAYPAL_SAME_ITEM_QUESTION'                => 'Dieser Artikel ist bereits im Warenkorb.<br> Möchtest Du %s Artikel zusätzlich hinzufügen?',
    'OEPAYPAL_SAME_ITEMS_QUESTION'               => 'Dieser Artikel ist bereits im Warenkorb.<br> Möchtest Du %s Artikel zusätzlich hinzufügen?',
