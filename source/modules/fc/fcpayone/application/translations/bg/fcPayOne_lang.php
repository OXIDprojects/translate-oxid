...
'FCPO_VOUCHER'                                  => '',
'FCPO_DISCOUNT'                                 => '',
'FCPO_WRAPPING'                                 => "Опаковка за подарък:",
'FCPO_GIFTCARD'                                 => "Поздравителна картичка",
'FCPO_SURCHARGE'                                => '',
'FCPO_DEDUCTION'                                => 'Удръжка',
'FCPO_PAYMENTTYPE'                              => "",
'FCPO_SHIPPINGCOST'                             => "",
...
'FCPO_CARD_SECURITY_CODE_DESCRIPTION'           => "CVV2/CVC2 3-цифрен код е отпечатан след полето за подпис на обратната страна на картата.<br>Обикновено е предхождан от номера на картата.",
'FCPO_TYPE_OF_PAYMENT'                          => "",
'FCPO_MIN_ORDER_PRICE'                          => "Минимална цена на поръчката",
'FCPO_PREVIOUS_STEP'                            => "",
'FCPO_CONTINUE_TO_NEXT_STEP'                    => "",
'FCPO_PAYMENT_INFORMATION'                      => "",
'FCPO_PAGE_CHECKOUT_PAYMENT_EMPTY_TEXT'         => '',

'FCPO_EMAIL_BANK_DETAILS'                       => 'Детайли на Банката',
'FCPO_EMAIL_BANK'                               => '',
...
'FCPO_KLV_BIRTHDAY'                             => 'Дата на раждане',
'FCPO_KLV_BIRTHDAY_INVALID'                     => '',
'FCPO_KLV_ADDINFO'                              => 'Допълнителна информация:',
...
'FCPO_PAYOLUTION_INSTALLMENT_NOT_YET_SELECTED'  => 'Моля изберете',
