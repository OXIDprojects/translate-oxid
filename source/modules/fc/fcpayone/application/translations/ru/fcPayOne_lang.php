...
'FCPO_CARD_SECURITY_CODE_DESCRIPTION'           => "Находится на обратной стороне Вашей кредитной карты. Контрольное число<br>- это последние три цифры.",
'FCPO_TYPE_OF_PAYMENT'                          => "",
'FCPO_MIN_ORDER_PRICE'                          => "Минимальная стоимость заказа",
'FCPO_PREVIOUS_STEP'                            => "",
'FCPO_CONTINUE_TO_NEXT_STEP'                    => "",
'FCPO_PAYMENT_INFORMATION'                      => "Информация об оплате",
'FCPO_PAGE_CHECKOUT_PAYMENT_EMPTY_TEXT'         => '',

'FCPO_EMAIL_BANK_DETAILS'                       => 'Подробности счёта',
'FCPO_EMAIL_BANK'                               => '',
...
'FCPO_KLV_CONFIRM'                              => '',
'FCPO_KLV_TELEPHONENUMBER'                      => 'Телефон',
'FCPO_KLV_TELEPHONENUMBER_INVALID'              => '',
'FCPO_KLV_BIRTHDAY'                             => 'День рождения:',
'FCPO_KLV_BIRTHDAY_INVALID'                     => '',
'FCPO_KLV_ADDINFO'                              => 'Дополнительная информация',
'FCPO_KLV_ADDINFO_INVALID'                      => '',
'FCPO_KLV_ADDINFO_DEL'                          => '',
'FCPO_KLV_SAL'                                  => 'Название',
'FCPO_KLV_PERSONALID'                           => '',
...
'FCPO_PAYOLUTION_YEAR'                          => 'Год',
'FCPO_PAYOLUTION_MONTH'                         => '',
'FCPO_PAYOLUTION_DAY'                           => 'Дня',
...
'FCPO_PAYOLUTION_INSTALLMENT_FINANCING_AMOUNT'  => 'Количество',
'FCPO_PAYOLUTION_INSTALLMENT_FINANCING_SUM'     => 'Итого',
'FCPO_PAYOLUTION_INSTALLMENT_NOT_YET_SELECTED'  => 'Выберите',
