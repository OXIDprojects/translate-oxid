...
'FCPO_GIFTCARD'                                 => "Вітальна листівка",
...
'FCPO_CARD_SECURITY_CODE_DESCRIPTION'           => "Знаходиться на зворотному боці Вашої кредитної карти. Контрольний код <br> - це останні три цифри.",
'FCPO_TYPE_OF_PAYMENT'                          => "",
'FCPO_MIN_ORDER_PRICE'                          => "Мінімальна вартість замовлення",
'FCPO_PREVIOUS_STEP'                            => "",
'FCPO_CONTINUE_TO_NEXT_STEP'                    => "",
'FCPO_PAYMENT_INFORMATION'                      => "Інформація про оплату",
'FCPO_PAGE_CHECKOUT_PAYMENT_EMPTY_TEXT'         => '',

'FCPO_EMAIL_BANK_DETAILS'                       => 'Подробиці рахунку',
'FCPO_EMAIL_BANK'                               => '',
...
'FCPO_KLV_BIRTHDAY'                             => 'День народження',
'FCPO_KLV_BIRTHDAY_INVALID'                     => '',
'FCPO_KLV_ADDINFO'                              => 'Додаткова інформація',
...
'FCPO_PAYOLUTION_YEAR'                          => 'Рік',
'FCPO_PAYOLUTION_MONTH'                         => '',
'FCPO_PAYOLUTION_DAY'                           => 'День',
...
'FCPO_PAYOLUTION_INSTALLMENT_FINANCING_AMOUNT'  => 'Кількість',
'FCPO_PAYOLUTION_INSTALLMENT_FINANCING_SUM'     => 'Разом',
'FCPO_PAYOLUTION_INSTALLMENT_NOT_YET_SELECTED'  => 'Виберіть',
