...
'FCPO_CARD_SECURITY_CODE_DESCRIPTION'           => "Αυτό το ψηφίο ελέγχου είναι τυπωμένο σε αντίστροφα πλάγια γράμματα στο πίσω μέρος της πιστωτικής σας κάρτας ακριβώς πάνω από το πάνελ της υπογραφής.",
'FCPO_TYPE_OF_PAYMENT'                          => "",
'FCPO_MIN_ORDER_PRICE'                          => "Ελάχιστη τιμή παραγγελίας",
'FCPO_PREVIOUS_STEP'                            => "",
'FCPO_CONTINUE_TO_NEXT_STEP'                    => "",
'FCPO_PAYMENT_INFORMATION'                      => "",
'FCPO_PAGE_CHECKOUT_PAYMENT_EMPTY_TEXT'         => '',

'FCPO_EMAIL_BANK_DETAILS'                       => 'Λεπτομέρειες Τράπεζας',
'FCPO_EMAIL_BANK'                               => '',
...
'FCPO_KLV_CONFIRM'                              => '',
'FCPO_KLV_TELEPHONENUMBER'                      => 'Τηλέφωνο',
'FCPO_KLV_TELEPHONENUMBER_INVALID'              => '',
'FCPO_KLV_BIRTHDAY'                             => 'Ημερομηνία γεννήσεως',
'FCPO_KLV_BIRTHDAY_INVALID'                     => '',
'FCPO_KLV_ADDINFO'                              => 'Επιπρόσθετες πληροφορίες',
...
'FCPO_PAYOLUTION_YEAR'                          => 'Έτος',
'FCPO_PAYOLUTION_MONTH'                         => '',
'FCPO_PAYOLUTION_DAY'                           => 'Ημέρα',
...
'FCPO_PAYOLUTION_INSTALLMENT_FINANCING_AMOUNT'  => 'Ποσό',
'FCPO_PAYOLUTION_INSTALLMENT_FINANCING_SUM'     => 'Σύνολο',
'FCPO_PAYOLUTION_INSTALLMENT_NOT_YET_SELECTED'  => 'Παρακαλώ επιλέξτε',
