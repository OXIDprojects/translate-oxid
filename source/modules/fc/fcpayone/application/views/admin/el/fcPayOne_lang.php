...
'FCPO_LIST_HEADER_CLEARINGTYPE'             => 'Τρόπος Πληρωμής',
...
'FCPO_WRAPPING'                             => "",
'FCPO_GIFTCARD'                             => "",
'FCPO_SURCHARGE'                            => 'Επιβάρυνση',
'FCPO_DEDUCTION'                            => '',
'FCPO_PAYMENTTYPE'                          => "",
'FCPO_SHIPPINGCOST'                         => "",
'FCPO_PRODUCT_CAPTURE'                      => "",
'FCPO_PRODUCT_AMOUNT'                       => "Ποσό",
'FCPO_PRODUCT_PRICE'                        => "Τιμή Μονάδος",
'FCPO_PRODUCT_TITLE'                        => "Προϊον",
'FCPO_COMPLETE_ORDER'                       => "Ολοκλήρωση παραγγελίας",
...
'fcpo_admin_config_add'                     => "Προσθήκη",
...
'FCPO_CONFIG_GROUP_GENERAL'                 => "Γενικά",
...
'FCPO_COUNTRIES'                            => "Χώρες",
'FCPO_LANGUAGE'                             => "Γλώσσες",
'FCPO_CURRENCY'                             => "",
...
'FCPO_CC_STANDARD_SELECTION'                => 'Επιλογή',
'FCPO_CC_STANDARD_FIELDS'                   => '',
'FCPO_CC_STANDARD_IFRAME'                   => '',
    
'FCPO_CC_ACTIVE'                            => 'Ενεργό',
'FCPO_CC_LANGUAGE'                          => 'Γλώσσα',
'FCPO_CC_SELECT'                            => 'Επιλογή',
    
'FCPO_CC_ERRORLANG_DE'                      => '',
'FCPO_CC_ERRORLANG_EN'                      => 'Ελληνικά',
'FCPO_CC_CUSTOM_TEMPLATE'                   => '',
'FCPO_CC_PREVIEW'                           => 'Προεπισκόπιση',
...
'FCPO_CC_HEADER_TYPE'                       => 'Τύπος',
'FCPO_CC_HEADER_DIGIT_COUNT'                => '',
'FCPO_CC_HEADER_DIGIT_MAX'                  => '',
'FCPO_CC_HEADER_IFRAME'                     => '',
'FCPO_CC_HEADER_WIDTH'                      => 'Πλάτος',
'FCPO_CC_HEADER_HEIGHT'                     => 'Ύψος',
...
'FCPO_CC_TYPE_PASSWORD'                     => 'Κωδικός',
'FCPO_CC_TYPE_TEXT'                         => 'Κείμενο',
...
'FCPO_PAYDIREKT_EXPRESS_BUTTON_NONE'        => 'Κανένα',
