...
'FCPO_LIST_HEADER_CLEARINGTYPE'             => 'お支払い方法',
'FCPO_LIST_HEADER_EMAIL'                    => '',
'FCPO_LIST_HEADER_PRICE'                    => '',
'FCPO_LIST_HEADER_TXACTION'                 => '都道府県',
'FCPO_EXECUTE'                              => '',
'FCPO_CAPTURE'                              => '',
'FCPO_DEBIT'                                => '',
'FCPO_ARE_YOU_SURE'                         => '',
...
'fcpo_admin_common'                         => 'ジェネラル',
'fcpo_admin_support'                        => '',
'fcpo_admin_api_logs'                       => '',
'FCPO_LIST_HEADER_TIMESTAMP'                => '時間:',
...
'FCPO_DISCOUNT'                             => '',
'FCPO_WRAPPING'                             => "",
'FCPO_GIFTCARD'                             => "グリーテイングカード",
'FCPO_SURCHARGE'                            => '割増',
'FCPO_DEDUCTION'                            => '差し引き',
'FCPO_PAYMENTTYPE'                          => "",
'FCPO_SHIPPINGCOST'                         => "",
'FCPO_PRODUCT_CAPTURE'                      => "",
'FCPO_PRODUCT_AMOUNT'                       => "総額",
'FCPO_PRODUCT_PRICE'                        => "単価",
'FCPO_PRODUCT_TITLE'                        => "製品",
'FCPO_COMPLETE_ORDER'                       => "完了しているご注文",
...
'fcpo_admin_config_add'                     => "追加",
'fcpo_admin_config_delete'                  => "",
'fcpo_admin_config_delete_confirm'          => "本当にこのエントリーを削除しますか？",
...
'FCPO_CONFIG_GROUP_GENERAL'                 => "ジェネラル",
...
'fcpo_admin_config_status_language'         => '言語',
...
'FCPO_CC_STANDARD_SELECTION'                => 'セレクション',
'FCPO_CC_STANDARD_FIELDS'                   => '',
'FCPO_CC_STANDARD_IFRAME'                   => '',
    
'FCPO_CC_ACTIVE'                            => '',
'FCPO_CC_LANGUAGE'                          => '言語',
'FCPO_CC_SELECT'                            => 'セレクション',
    
'FCPO_CC_ERRORLANG_DE'                      => '',
'FCPO_CC_ERRORLANG_EN'                      => '日本語',
'FCPO_CC_CUSTOM_TEMPLATE'                   => '',
'FCPO_CC_PREVIEW'                           => 'プレビュー',
...
'FCPO_CC_TYPE_PASSWORD'                     => 'パスワード',
'FCPO_CC_TYPE_TEXT'                         => 'テキスト',
    
'FCPO_CC_IFRAME_STANDARD'                   => 'スタンダード',
...
'FCPO_PAYDIREKT_EXPRESS_BUTTON_NONE'        => 'なし',
