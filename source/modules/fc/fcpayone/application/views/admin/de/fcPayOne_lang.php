...
'FCPO_ARE_YOU_SURE'                         => 'Bist Du sicher, dass Du diese Aktion ausführen möchtest?',
'FCPO_DE'                                   => 'Deutschland',
'FCPO_AT'                                   => 'Österreich',
'FCPO_NL'                                   => 'Niederlande',
...
'FCPO_HELP_MERCHANTID'                      => 'Deine PAYONE Merchant-ID (PAYONE Kundennummer) findest Du auf allen Abrechnungen von PAYONE sowie rechts oben im PAYONE Merchant Interface (PMI).',
'FCPO_HELP_PORTALID'                        => 'Bitte trage hier die ID des PAYONE Zahlungsportals ein, über welches die Zahlungen abgewickelt werden sollen.<br>Die Portal-ID findest Du unter <a href="http://www.payone.de" target="_blank">http://www.payone.de</a> > Händler-Login unter dem Menüpunkt Konfiguration > Zahlungsportale<br><br>Alle relevanten Parameter zur Konfiguration erhälst Du nach Auswahl von [editieren] unter dem Reiter [API-Parameter]',
'FCPO_HELP_PORTALKEY'                       => 'Bitte trage hier den Key zur Absicherung des Datenaustausches ein. Dieser kann bei der Konfiguration des PAYONE Zahlungsportals von Dir frei festgelegt werden.<br>Die Konfiguration findest Du unter <a href="http://www.payone.de" target="_blank">http://www.payone.de</a> > Handler-Login unter dem Menüpunkt Konfiguration > Zahlungsportale > [editieren] > Reiter [Erweitert] > Key<br><br>Alle relevanten Parameter zur Konfiguration erhälst Du nach Auswahl des Reiters [API-Parameter]',
'FCPO_HELP_OPERATIONMODE'                   => 'Hier kannst Du für diese Zahlungsart festlegen, ob die Zahlungen im Testmodus abgewickelt oder live ausgeführt werden. Bitte beachte, dass für den Testmodus die definierten Testdaten verwendet werden müssen.',
'FCPO_HELP_OPERATIONMODE'                    => 'Hier kannst Du für diese Zahlungsart festlegen, ob die Zahlungen im Testmodus abgewickelt oder live ausgeführt werden. Bitte beachte, dass für den Testmodus die definierten Testdaten verwendet werden müssen.',
'FCPO_HELP_SUBACCOUNTID'                    => 'Bitte trage hier die ID des Sub-Accounts ein, über welchen die Zahlungen abgewickelt und zugeordnet werden sollen.<br>Die ID findest Du unter <a href="http://www.payone.de" target="_blank">http://www.payone.de</a> > Händler-Login unter dem Menüpunkt Konfiguration > Accounts<br><br>Alle relevanten Parameter zur Konfiguration erhälst Du unter <a href="http://www.payone.de" target="_blank">http://www.payone.de</a> > Händler-Login unter dem Menüpunkt Konfiguration > Zahlungsportale > [editieren] > Reiter [API-Parameter]',
'FCPO_HELP_POSCHECK'                        => 'Hier kannst Du definieren, ob eine Prüfung der Bankverbindung gegen die POS-Sperrdatei durchgeführt werden soll. Bitte beachte, dass das Modul "Protect" beauftragt worden sein muss und die Prüfung nur für die Zahlungsart Lastschrift Deutschland durchgeführt wird.',
...
'FCPO_CREDITCARDBRANDS_INFOTEXT'            => 'Hier kannst Du die einzelnen Kreditkartenbrands für die Zahlart Kreditkarte aktivieren und konfigurieren.<br>Bitte beachte, dass der jeweilige Kreditkartenbrand bei PAYONE beauftragt worden sein muss.<br>Die Einstellung für die Zahlungsart Kreditkarte nimmst Du bitte unter PAYONE -> Konfiguration -> Zahlungsarten vor.',
'FCPO_ACTIVE_ONLINE_UBERWEISUNG_TYPES'      => 'Aktive Online-überweisungsarten',
'FCPO_ONLINEUBERWEISUNG_INFOTEXT'           => 'Hier kannst Du die einzelnen Online-überweisungsarten für die Zahlart Online-überweisung aktivieren und konfigurieren.<br>Bitte beachte, dass die jeweilige Online-überweisungsart bei PAYONE beauftragt worden sein muss.<br>Die Einstellung für die Zahlungsart Online-überweisungsart nimmst Du bitte unter PAYONE -> Konfiguration -> Zahlungsarten vor.',
...
'FCPO_ORDER_LIST_YOUWANTTODELETE'           => 'Willst Du diesen Eintrag wirklich löschen?\n ACHTUNG: ggf. offene PAYONE Vorgänge zu dieser Bestellung bitte vor dem Löschen abschließen!',
...
'FCPO_HELP_BONI_OPERATIONMODE'              => 'Hier kannst Du für die Bonitätsprüfung festlegen ob die Überprüfungen im Testmodus abgewickelt werden, oder ob diese live ausgeführt werden.',
...
'FCPO_HELP_CORRECT_ADDRESS'                 => 'Übernahme der jeweils durch die Adressprüfung korrigierten Adresse anstatt der eingegebenen Adresse in Deinen Shop.',
...
'FCPO_HELP_DURABILITY_BONICHECK'            => 'Anzahl in Tagen, nach der eine neue Bonitätsprüfung durchgeführt wird.<br><br>Bitte beachte die Bestimmungen des BDSG und der Vertragsbedingungen bzgl. der Speicherung und der Lebensdauer der Bonitätsprüfungen. Es wird empfohlen, eine Lebensdauer von einem Tag zu konfigurieren.',
'FCPO_MODULE_VERSION'                       => 'Version Modul',
'FCPO_STARTLIMIT_BONICHECK'                 => 'Bonitätsprüfung ab Warenwert',
'FCPO_HELP_STARTLIMIT_BONICHECK'            => 'Bonitätsprüfung wird nur ausgeführt wenn der Warenwert höher als der hier konfigurierte Wert ist.<br><br>Wenn die Bonitätsprüfung immer durchgeführt werden soll, lass dieses Feld leer.',
...
'FCPO_MAIN_CONFIG_INFOTEXT'                 => 'Du kannst für jede Zahlart einzeln konfigurieren, ob diese im Test- oder Livemodus abgewickelt werden soll. Die Einstellung findest Du unter PAYONE -> Konfiguration -> Zahlungsarten. Wir empfehlen Dir nach der initialen Konfiguration sowie bei Konfigurationsänderungen zunächst alle Zahlungsprozesse im Testmodus durchzuführen.',
'FCPO_BONICHECK_CONFIG_INFOTEXT'            => 'Bitte beachte, dass Du die nachfolgenden Optionen nur dann nutzen kannst, wenn Du das Modul Protect von PAYONE beauftragt hast. Die Nutzung der Bonitätsprüfung und der Adressprüfung zieht variable Kosten pro Vorgang nach sich, die Du Deinem Vertrag entnehmen kannst.',
'FCPO_BONICHECK_CONFIG_INFOTEXT_SMALL'      => 'Bitte nimm die Einstellungen für die Bonitätsprüfung mit Bedacht vor. Die Bonitätsprüfung wird nach Eingabe der Personendaten durchgeführt und beeinflusst die Zahlungsarten, die Deinen Kunden im Checkout-Prozess angeboten werden. Die Bonitätsprüfung sollte lediglich bei Zahlungsarten eingesetzt werden, die ein Zahlungsausfallrisiko für Dich nach sich ziehen (z.B. offene Rechnung oder Lastschrift). Du konfigurierst dies über die Einstellung "Bonitätsindex" in der Konfiguration der jeweiligen Zahlart. Du solltest in Deinem Shop außerdem in geeigneter Weise darauf hinweisen, dass Du Bonitätsprüfungen über die InfoScore Consumer Data GmbH durchführst.',
...
'FCPO_HELP_SETTLE_ACCOUNT'                  => 'Deaktiviere für Teileinzüge die Checkbox "Saldenausgleich durchführen". Bei der letzten Teillieferung muss diese Option aktiviert werden, um einen Kontenausgleich durchzuführen.',
...
'FCPO_HELP_CONSUMERSCORE_MOMENT'            => "Hier kannst Du definieren, wann der Kunde geprüft werden soll. Die Bonitätsprüfung wird nur durchgeführt wenn der Bonitätsindex der Zahlart einen Wert größer 0 entspricht.<br><br>Optionen:<br><br><ul><li>Vor Zahlartauswahl<br>Die Bonität des Kunden wird geprüft, wenn die notwendigen Adress und Namesinformationen vorliegen. Dies geschieht vor der Auswahl der Zahlart. Diese Prüfung findet nicht sichtbar für den Kunden im Hintergrund statt.<br><br></li><li>Nach Zahlartauswahl<br>Bei Auswahl dieser Option erscheint ein Auswahlfeld in dem Du auswählen kannst, für welche Zahlarten eine anschließende Bonitätsprüfung stattfinden soll.</li></ul>",
...
'fcpo_admin_config_delete_confirm'          => "Möchtest Du diesen Eintrag wirklich löschen?",
...
'FCPO_AMAZONPAY_ERROR_GETTING_CONFIG'       => 'Es gab ein Problem beim Abrufen der AmazonPay-Konfigurationseinstellungen. Nähere Infos findest Du im Admin unter PAYONE Protokolle/Logs->API Logs.',
...
'FCPO_HELP_KLARNA_CAMPAIGNS'                => "Die Bestellungen werden bei Klarna nur akzeptiert, wenn die Kombination aus Land, Sprache und Währung zusammenpasst.<br>Du mußt diese Kombinationen hier auch hinterlegen und der Kunde bekommt dann nur die passenden Kampagnen angezeigt.",
...
'FCPO_PAYPAL_LOGOS'                         => 'Hier kannst Du die verwendeten PayPal Express Logos hinterlegen.',    
...
'FCPO_HELP_PAYDIREKT_BUTTONTYPE'            => 'Wähle das passende Design des Paydirekt-Express Buttons.',
...
'FCPO_PAYDIREKT_SHIPPING_TERMS_URL'         => 'Webadresse (URL) zur Seite Deiner Lieferbedingungen',
'FCPO_HELP_PAYDIREKT_SHIPPING_TERMS_URL'    => 'Die Angabe einer Webadresse zu Deinen Lieferbedinungen ist verpflichtend notwendig für die Verwendung von Paydirekt Express',
'FCPO_PAYDIREKT_EXPRESS_DELIVERY_NONE'      => 'Keine Auswahl (OXID-Standard wird verwendet)',
'FCPO_HELP_PAYDIREKT_DELIVERYSET'           => 'Bitte wähle die Lieferkosten, die für PayidirektExpress Bestellungen verwendet werden sollen',
...
'FCPO_HELP_TRANSACTIONREDIRECTLOGGING'      => 'Hier kannst Du die Protokollierung von Transaktionsstatusweiterleitungen aktivieren. Entsprechende Aktivitäten landen dann in der Datei <i>fcpo_message_forwarding.log</i> im Logverzeichnis des Shops. Die Protokollierung sollte nicht dauerhaft aktiviert werden, da dies große Logdateien erzeugt',
'FCPO_HASH_METHOD'                          => 'Key-Verschlüsselungsverfahren',
'FCPO_HELP_HASH_METHOD'                     => 'Hier kannst Du einstellen, welches Key-Verschlüsselungsverfahren zur Kommunikation mit der Payone-API verwendet wird. Wenn möglich, wird die Verwendung von sha2-384 empfohlen.',
'FCPO_BONI_ERROR_SET_TO_BONIVERSUM_PERSON'  => '<b>Bitte beachte:</b><br>Der Adresschecktyp wurde auf "Boniversum Adresscheck Person" gesetzt, da Deine Bonitätsprüfung auf "Boniversum VERITA Score" gestellt ist.',
'FCPO_BONI_ERROR_DEACTIVATED_REGULAR_ADDRESSCHECK' => '<b>Bitte beachte:</b><br>Die eigenständige Addressprüfung wurde deaktiviert, weil Du die Bonitätsprüfung aktiviert hast. Die hiermit zusammenhängenden Addresschecks werden seperat eingestellt.',
'FCPO_BONI_ERROR_DEACTIVATED_BONI_ADDRESSCHECK' => '<b>Bitte beachte:</b><br>Die Bonitäts-Adressprüfung wurde deaktiviert, weil Du die Bonitätsprüfung deaktiviert hast.',
'FCPO_BONI_ERROR_NO_BONIADDRESSCHECK_SET'  => '<b>Bitte beachte:</b><br>Die Bonitäts-Adressprüfung wurde auf "BASIC" gesetzt, weil Du die Bonitätsprüfung aktiviert, aber noch keinen dazugehörige Adressprüfung ausgewählt hast.',
'FCPO_BONI_ERROR_SET_TO_BASIC'              => '<b>Bitte beachte:</b><br>Der Adresschecktyp wurde auf "Basic" gesetzt, weil die von Dir gewählte Kombination aus Boni- und Adresscheck nicht erlaubt ist.',
'FCPO_BONI_ERROR_SET_TO_PERSON'             => '<b>Bitte beachte:</b><br>Der Adresschecktyp wurde auf "Person" gesetzt, weil die von Dir gewählte Kombination aus Boni- und Adresscheck nicht erlaubt ist.',
'FCPO_ADDRESSCHECKTYPE_REGULAR_SET_INACTIVE' => '<b>Bitte beachte:</b><br>Die eigenständige Addressprüfung wurde deaktiviert, weil Du die Bonitätsprüfung aktiviert hast. <br>Bitte konfiguriere die Adressprüfung im Bereich der Bonitätsprüfung.',
'FCPO_EMAIL_CLEARING_SUBJECT'                   => 'Deine Überweisungsdaten zur Bestellnummer',
'FCPO_EMAIL_CLEARING_BODY_WELCOME'              => "Hallo %NAME% %SURNAME%,\nzur Begleichung der Rechnung verwende bitte folgende Daten in der Überweisung:\n\n",
