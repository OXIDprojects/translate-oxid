...
'FCPO_HELP_OPERATIONMODE'                    => 'Here you can configure if the payments are processed in test mode, or whether they are performed live. Please note that for using the test mode, usage of defined test data is required.',
