...
$aLang = [
    ...
    'ORDER_MAIN_SHIPPING_INFORMATION'                    => "Delivery Information",
    ...
    'PAYMENT_MAIN_ADDSUMRULES_ALLGOODS'                  => '1. Value of all items in basket',
    ...
    'SHOP_MAIN_VATNUMBER'                                => 'VAT ID',
    'SHOP_MAIN_TAXNUMBER'                                => 'VAT ID',
    ...
    'SHOP_CONFIG_CALCULATEVATFORDELIVERY'                     => 'Display delivery costs as net price and VAT (instead of gross) in shopping basket and invoice',
    'SHOP_CONFIG_CALCDELVATONTOP'                             => 'Enter delivery Costs as net Price (plus VAT)',
    ...
    'SHOP_CONFIG_CALCWRAPVATONTOP'                            => 'Enter prices for gift wrapping and greeting cards excluding VAT',
    'SHOP_CONFIG_CALCULATEVATOFORPAYCHARGE'                   => 'Display VAT contained in Payment Method Charges in basket and Invoice',
    ...
    'SHOP_CONFIG_DELIVERYCOSTS'                               => 'Calculate default delivery costs when User is not logged in yet',
    ...
    'SHOP_CONFIG_EXCLUDENONMATERIALPRODUCTS'                  => "Don't consider intangible Products (e.g. Gift Certificates) in delivery Costs Calculation",
    'SHOP_CONFIG_ENTERNETPRICE'                               => 'Enter product prices excluding VAT',
    'SHOP_CONFIG_VIEWNETPRICE'                                => 'Show prices w/o VAT in frontend (B2B)',
    ...
    'SHOP_CONFIG_SHIPPINGCOUNTRYVAT'                          => 'Use delivery country for VAT calculation instead of billing country',
    ...
    'SHOP_CONFIG_BASKETRESERVATIONTIMEOUT'                    => 'Seconds of basket expiration timeout',
    ...
    'SHOP_SYSTEM_OTHERCOUNTRYORDER'                      => 'Allow Orders from foreign Countries if no delivery Costs are defined',
    ...
    'TOOLTIPS_ARTICLEUNITDESCRIPTION'         => 'Under the basic price is the price to understand, based<br> on a specific unit of measure applies, including<br> the VAT and other price components.',
    ...
    'SHOP_PERF_LOADDELIVERY'                  => 'Calculate delivery Costs',
    ...
    'SHOP_RDFA_CONTENT_DELIVERY'      => 'In which content page the RDF data of not assigned <b>delivery methods</b> shall be embedded?',
    ...
    'OLC_ERROR_RESPONSE_UNEXPECTED' => 'Service unavailable, please try again later. If this error persists, please check if your server is able to establish outgoing connections.',
