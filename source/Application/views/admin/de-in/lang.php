...
$aLang = [
    ...
    'CATEGORY_MALL_CLICKHEREFORPARENT'          => 'Hier klicken um Eltern Verknüpfung zu editieren.',
    ...
    // @deprecated 6.6.0 dynpages will be removed on the next major
        ...
        'DYN_ECONDA_COPY_FILE'                      => 'Du musst dazu die Datei "emos2.js", die Du von ECONDA erhälst, in das Verzeichnis %s kopieren',
    // END deprecated

    'DYNBASE_ADDCATTOCAMPAIGN'                       => 'Hauptkategorie zum Kampagnenparameter hinzufügen',
    'DYNBASE_DO_SUCCESS'                             => 'Erfolg! Du kannst Deine Exportdatei <a href="%s" target="_blank">hier</a> herunterladen.',
    ...
    'MODULE_DELETEEXTENSION'                         => 'Möchtest Du alle registrierten Modulinformationen und gespeicherten Konfigurationseinstellungen löschen?',
    ...
    'LANGUAGE_ABBRCHANGEMAINLANG_WARNING'            => 'Warnung: Du kannst nicht die Abkürzung der Hauptsprache (Sprach-ID 0) ändern!',
    ...
    // END deprecated
    'NAVIGATION_NEW_VERSION_AVAILABLE'               => 'Du verwendest Version %s, Version %s ist jetzt verfügbar. Bitte aktualisiere jetzt.',
    ...
    'ORDER_ARTICLE_YOUWANTTOSTORNO'                      => 'Willst Du diesen Artikel wirklich stornieren?',
    ...
    'SHOP_CACHE_ENABLE_CACHE'                            => 'Möchtest Du wirklich aktivieren?',
    ...
    'SHOP_MALL_UPDATEVIEWSCONFIRM'                       => 'Bist Du sicher, dass Sie die VIEWS jetzt updaten willst?',
    ...
    'SHOP_MAIN_ISSUPERSHOP'                              => 'Dieser Shop ist ein Supershop. Du kannst Artikel mit anderen Shops verknüpfen.',
    ...
    'SHOP_MAIN_SENT_NOW_SUBJECT'                         => 'E-Mail-Betreff "Jetzt versendet"',
    ...
    'SYSREQ_PHP_VERSION'                      => 'PHP-Version von 7.3 bis 8.0',
    // END deprecated
    ...
    'PAYMENT_RDFA_ADVICE'                  => '<b>Hinweis:</b> Bitte wähle nur die in GoodRelations vordefinierten Zahlungsarten aus, die Deiner Zahlungsart <b>%s</b> entsprechen.',
    ...
    'DELIVERY_RDFA_ADVICE'                     => '<b>Hinweis:</b> Bitte wähle nur die in GoodRelations vordefinierten Versandarten aus, die Deiner Versandart <b>%s</b> entsprechen',
    ...
    'CUSTOM_TEMPLATE_EXIST_FOR_DELETED_SHOP' => 'Der gelöschte Shop verwendet eigene Templates. Lösche diese manuell, falls gewünscht.',
    ...
    'OXDIAG_INTROINFORMATION_CONTACT_US'             => 'Du kannst Dich mit uns in Verbindung setzen. Verwende das',
    ...
    'OXDIAG_ABOUT'                    => 'Dieses Modul sammelt technische Informationen über Ihren Shop und den Server. Diese Informationen können vor einem Update, einer Modulinstallation oder zu Diagnosezwecken interessant sein.',
    ...
    'OXDIAG_SRVINF_NOTE'              => 'Bemerkung: Diese Informationen beziehen sich auf den aktuellen Runtime-Frontend-Server. Solltest Du mehr als einen Frontend-Server in Betrieb haben, kannst Du deren Informationen durch direkten Zugriff auf die entsprechenden Server abrufen.',
    'OXDIAG_SERVERINFO_NOT_DETECTED'  => 'icht erkannt',
    ...
    'OLC_ERROR_SERIAL_NOT_VALID'    => 'Lizenzschlüsselabgleich fehlgeschlagen. Bitte versuch es später noch einmal oder kontaktiere den Support, falls dieses Problem weiterhin bestehen sollte.',
