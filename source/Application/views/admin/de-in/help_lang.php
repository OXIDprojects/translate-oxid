...
'HELP_SHOP_SYSTEM_VARIANTPARENTBUYABLE'       => 'Hier kannst Du einstellen, ob der Vater-Artikel gekauft werden kann:<ul><li>Wenn die Einstellung aktiv ist, kann auch der Vater-Artikel gekauft werden.</li><li>Wenn die Einstellung nicht aktiv ist, können nur die Varianten gekauft werden.</li></ul>',
...
'HELP_SHOP_CONFIG_BIDIRECTCROSS'              => 'Durch Crossselling können zu einem Artikel passende Artikel angeboten werden. Crossselling-Artikel werden im eShop bei <span class="filename_filepath_or_italic">Kennst Du schon?</span> angezeigt.<br>Wenn z.B. einem Auto als Crossselling-Artikel Winterreifen zugeordnet sind, werden beim Auto die Winterreifen angezeigt. Wenn Bidirektionales Crossselling aktiviert ist, funktioniert Crossselling in beide Richtungen: bei den Winterreifen wird das Auto angezeigt.',

'HELP_SHOP_CONFIG_STOCKONDEFAULTMESSAGE'      => 'Bei jedem Artikel kannst Du einrichten, welche Meldung den Benutzern angezeigt wird, wenn der Artikel auf Lager ist. Wenn diese Einstellung aktiv ist, wird den Benutzern auch dann eine Meldung angezeigt, wenn bei einem Artikel keine eigene Meldung hinterlegt ist. Dann die Standardmeldung <span class="filename_filepath_or_italic">sofort lieferbar</span> angezeigt.<br>Weitere Informationen findest Du im <a href="http://www. oxid-esales. com/de/resources/help-faq/eshop-manual/meldungen-zu-den-lagerbestaenden-einrichten" target="_blank">Handbuch-Beitrag zu den Lagerbestandsmeldungen</a>.',

'HELP_SHOP_CONFIG_STOCKOFFDEFAULTMESSAGE'     => 'Bei jedem Artikel kannst Du einrichten, welche Meldung den Benutzern angezeigt wird, wenn der Artikel nicht auf Lager ist. Wenn diese Einstellung aktiv ist, wird den Benutzern auch dann eine Meldung angezeigt, wenn bei einem Artikel keine eigene Meldung hinterlegt ist. Dann die Standardmeldung <span class="filename_filepath_or_italic">Dieser Artikel ist nicht auf Lager und muss erst nachbestellt werden</span> angezeigt.<br>Weitere Informationen findest Du im <a href="http://www. oxid-esales. com/de/resources/help-faq/eshop-manual/meldungen-zu-den-lagerbestaenden-einrichten" target="_blank">Handbuch-Beitrag zu den Lagerbestandsmeldungen</a>.',

'HELP_SHOP_CONFIG_OVERRIDEZEROABCPRICES'      => 'Du kannst für bestimmte Benutzer spezielle Preise einrichten. Dadurch kannst Du bei jedem Artikel A, B, und C-Preise eingeben. Wenn Benutzer z. B. in der Benutzergruppe Preis A sind, wird Dir die A-Preise anstatt des normalen Artikelpreises angezeigt.<br>Wenn die Einstellung aktiv ist, wird diesen Benutzern der normale Artikelpreis angezeigt, wenn für den Artikel kein A, B oder C-Preis vorhanden ist.<br>Du solltest diese Einstellung aktivieren, wenn Du A, B und C-Preise verwendest: Ansonsten wird den bestimmten Benutzern ein Preis von 0,00 angezeigt, wenn kein A, B oder C-Preis hinterlegt ist.',

'HELP_SHOP_CONFIG_SEARCHFIELDS'               => 'Hier kannst Du die Datenbankfelder der Artikel eingeben, in denen gesucht wird. Gib pro Zeile nur ein Datenbankfeld ein.<br>Die am häufigsten benötigten Einträge sind:<ul><li>oxtitle = Titel (Name) der Artikel</li><li>oxshortdesc = Kurzbeschreibung der Artikel</li><li>oxsearchkeys = Suchwörter, die bei den Artikeln eingetragen sind</li><li>oxartnum = Artikelnummern</li><li>oxtags = Stichworte, bei den Artikeln eingetragen sind</li></ul>',

'HELP_SHOP_CONFIG_SORTFIELDS'                 => 'Hier kannst Du die Datenbankfelder der Artikel eingeben, nach denen Artikellisten sortiert werden können. Gib pro Zeile nur ein Datenbankfeld ein.<br>Die am häufigsten benötigten Einträge sind:<ul><li>oxtitle = Titel (Name) der Artikel</li><li>oxprice = Preis der Artikel</li><li>oxvarminprice = Der niedrigste Preis der Artikel, wenn Varianten mit verschiedenen Preisen verwendet werden.</li><li>oxartnum = Artikelnummern</li><li>oxrating = Die Bewertung der Artikel</li><li>oxstock = Lagerbestand der Artikel</li></ul>',

'HELP_SHOP_CONFIG_MUSTFILLFIELDS'             => 'Hier kannst Du eingeben, welche Felder von Benutzern ausgefüllt werden müssen, wenn sie sich registrieren. Du musst die entsprechenden Datenbankfelder angeben. Gib pro Zeile nur ein Datenbankfeld ein.<br>Die am häufigsten benötigten Einträge für die Benutzerdaten sind:<ul><li>oxuser__oxfname = Vorname</li><li>oxuser__oxlname = Nachname</li><li>oxuser__oxstreet = Straße</li><li>oxuser__oxstreetnr = Hausnummer</li><li>oxuser__oxzip = Postleitzahl</li><li>oxuser__oxcity = Stadt</li><li>oxuser__oxcountryid = Land</li><li>oxuser__oxfon = Telefonnummer</li></ul><br>Du kannst auch angeben, welche Felder ausgefüllt werden müssen, wenn Benutzer eine Lieferadresse eingeben. Die am häufigsten benötigten Einträge sind:<ul><li>oxaddress__oxfname = Vorname</li><li>oxaddress__oxlname = Nachname</li><li>oxaddress__oxstreet = Straße</li><li>oxaddress__oxstreetnr = Straßennummer</li><li>oxaddress__oxzip = Postleitzahl</li><li>oxaddress__oxcity = Stadt</li><li>oxaddress__oxcountryid = Land</li><li>oxaddress__oxfon = Telefonnummer</li></ul>',

'HELP_SHOP_CONFIG_USENEGATIVESTOCK'           => 'Mit <span class="navipath_or_inputname">Negative Lagerbestände erlauben</span> kannst Du einstellen, welcher Lagerbestand berechnet wird, wenn ein Artikel ausverkauft ist:<br><ul><li>Wenn die Einstellung aktiv ist, werden negative Lagerbestände berechnet, wenn weitere Exemplare bestellt werden.</li><li>Wenn die Einstellung nicht aktiv ist, fällt der Lagerbestand eines Artikels nie unter 0. Auch dann nicht, wenn der Artikel bereits ausverkauft ist und noch weitere Exemplare bestellt werden.</li></ul>',

'HELP_SHOP_CONFIG_SETORDELETECURRENCY'        => 'Hier kannst Du Währungen hinzufügen oder entfernen. Jede Zeile enthält Währungsparameter, die durch das Symbol @ getrennt werden.<br /><br /><ul><li>Währungsabkürzung laut ISO 4217 (z.B. EUR)</li><li>Wechselkurs zur Basiswährung mit dem Wert 1.00</li><li>Dezimaltrennzeichen</li><li>Tausendertrennzeichen</li><li>Währungszeichen</li><li>Anzahl der Nachkommastellen</li><li>optionaler Parameter "Front". Falls angegeben, wird die Währungsabkürzung vor dem Preis angezeigt.</li></ul>',
...
'HELP_SHOP_CONFIG_PSLOGIN'                    => 'Transformiert Deinen Shop in einen Shop mit beschränktem Zugriff. Auf diese Weise erzeugst Du Private Sales Communities mit geschlossenen Nutzergruppen.',
...
'HELP_SHOP_CONFIG_INVITATION'                 => 'Mit Einladungen können Deine Kunden weitere Freunde einladen sich zu registrieren und Bonuspunkte zu sammeln. Die Anzahl der gesammelten Bonuspunkte wird im jeweiligen Benutzerprofil gespeichert. Du als Shopbetreiber kannst diese Bonuspunkte dann je nach Deinem Geschäftskonzept einsetzen.',
...
'HELP_SHOP_CONFIG_MAX_DOWNLOADS_COUNT'        => 'Gib hier an, wie oft Benutzer nach einer Bestellung den Link zum Download verwenden können. Das ist die Standardeinstellung für alle Artikel. Du kannst diesen Wert für jede Datei des Artikels unter Artikel verwalten -> Artikel -> Downloads ändern.',

'HELP_SHOP_CONFIG_LINK_EXPIRATION_TIME_UNREGISTERED' => 'Gib hier an, wie oft Benutzer, die ohne Registrierung bestellt haben, den Link zum Download verwenden können. Das ist die Standardeinstellung für alle Artikel. Du kannst diesen Wert für jede Datei des Artikels unter Artikel verwalten -> Artikel -> Downloads ändern.',

'HELP_SHOP_CONFIG_LINK_EXPIRATION_TIME'       => 'Gib die Zeit in Stunden an, die der Downloadlink nach der Bestellung gültig ist. Das ist die Standardeinstellung für alle Artikel. Du kannst diesen Wert für jede Datei des Artikels unter Artikel verwalten -> Artikel -> Downloads ändern.',

'HELP_SHOP_CONFIG_PARCELSERVICE'              => 'Bitte trage die Tracking-URL Ihres Versanddienstleisters ein. <i>##ID##</i> ist ein Platzhalter, welcher durch die jeweilige Sendungsnummer ersetzt wird.',
...
'HELP_SHOP_CONFIG_INCLUDE_PRODUCT_REVIEW_LINKS_IN_ORDER_EMAIL' => 'Bitte prüfe, ob dies nach dem jeweils anwendbaren Recht konform ist. Diese Einstellung wird nur angewendet, wenn "Bewertungen und Sterne-Ratings" aktiviert ist.',

'HELP_SHOP_MALL_MALLMODE'                     => 'Hier stellst Du ein, was auf der Startseite dieses eShops angezeigt werden soll: <ul><li><span class="navipath_or_inputname">Shop-Auswahlseite</span>: Eine Seite wird angezeigt, auf der Kunden zwischen den verschiedenen Shops wählen können.</li><li><span class="navipath_or_inputname">Hauptshop anzeigen</span>: Die normale Startseite des Hauptshops wird angezeigt.</li></ul>wird angezeigt.</li></ul>',
...
'HELP_SHOP_PERF_NEWESTARTICLES'               => 'In Deinem eShop wird eine Liste mit den neusten Artikeln (Frisch eingetroffen!) angezeigt. Hier kannst Du einstellen, wie die Liste generiert wird:<ul><li><span class="userinput_or_code">ausgeschaltet</span>: Die Liste wird nicht angezeigt.</li><li><span class="userinput_or_code">manuell</span>: Du kannst unter <span class="navipath_or_inputname">Kundeninformationen -> Aktionen verwalten</span> in der Aktion <span class="navipath_or_inputname">Frisch eingetroffen</span> einstellen, welche Artikel in der Liste angezeigt werden.</li><li><span class="userinput_or_code">automatisch</span>: Die Liste der neusten Artikel wird automatisch berechnet.</li></ul>',

'HELP_SHOP_PERF_TOPSELLER'                    => 'In Deinem eShop wird eine Liste mit den meistverkauften Artikeln (Top of the Shop) angezeigt. Hier kannst Du einstellen, wie die Liste generiert wird:<ul><li><span class="userinput_or_code">ausgeschaltet</span>: Die Liste wird nicht angezeigt.</li><li><span class="userinput_or_code">manuell</span>: Du kannst unter <span class="navipath_or_inputname">Kundeninformationen -> Aktionen verwalten</span> in der Aktion <span class="navipath_or_inputname">Topseller</span> einstellen, welche Artikel in der Liste angezeigt werden.</li><li><span class="userinput_or_code">automatisch</span>: Die Liste der meistverkauften Artikel wird automatisch berechnet.</li></ul>',
...
'HELP_SHOP_SEO_TITLEPREFIX'                   => 'Jede einzelne Seite hat einen Titel. Er wird im Browser als Titel des Browser-Fensters angezeigt. Mit <span class="navipath_or_inputname">Titel Präfix</span> und <span class="navipath_or_inputname">Titel Suffix</span> hast Du die Möglichkeit, vor und hinter jeden Seitentitel Text einzufügen:<br><ul><li>Gib in <span class="navipath_or_inputname">Titel Präfix</span> den Text ein, der vor dem Titel erscheinen soll.</li><li>Gib in <span class="navipath_or_inputname">Titel Suffix</span> den Text ein, der hinter dem Titel erscheinen soll.</li></ul>',

'HELP_SHOP_SEO_TITLESUFFIX'                   => 'Jede einzelne Seite hat einen Titel. Er wird im Browser als Titel des Browser-Fensters angezeigt. Mit <span class="navipath_or_inputname">Titel Präfix</span> und <span class="navipath_or_inputname">Titel Suffix</span> hast Du die Möglichkeit, vor und hinter jeden Seitentitel Text einzufügen:<br><ul><li>Gib in <span class="navipath_or_inputname">Titel Präfix</span> den Text ein, der vor dem Titel erscheinen soll.</li><li>Gib in <span class="navipath_or_inputname">Titel Suffix</span> den Text ein, der hinter dem Titel erscheinen soll.</li></ul>',

'HELP_SHOP_SEO_IDSSEPARATOR'                  => 'Das Trennzeichen wird verwendet, wenn Kategorie- oder Artikelnamen aus mehreren Worten bestehen. Das Trennzeichen wird anstelle eines Leerzeichens in die URL eingefügt, z. B. www.deinonlineshop.de/Kategorie-aus-mehreren-Worten/Artikel-aus-mehreren-Worten.html<br>Wenn Du kein Trennzeichen eingibst, wird der Bindestrich - als Trennzeichen verwendet.',
...
'HELP_SHOP_MAIN_PRODUCTIVE'                   => 'Solange diese Einstellung <span class="warning_or_important_hint">nicht</span> aktiv ist, werden am unteren Ende jeder Seite Informationen zu Ladezeiten angezeigt. Außerdem werden Debug-Informationen angezeigt. Diese Informationen sind für Entwickler wichtig, wenn sie den OXID eShop anpassen.<br><span class="warning_or_important_hint">Aktiviere diese Einstellung, bevor Dein eShop öffentlich zugänglich gemacht wird! Dadurch wird den Benutzern nur der eShop ohne die zusätzlichen Informationen angezeigt.</span><br>Weitere wichtige Hinweise für den Livegang des OXID eShop findest Du in unserer <a href="http://oxidforge.org/de/check-vor-dem-livegang.html" target="_blank">OXIDforge</a>.',
...
'HELP_ARTICLE_PICTURES_ICON'                  => 'Icons sind die kleinsten Bilder eines Artikels, sie werden z. B. im Warenkorb verwendet. <br>Wenn Du ein Icon manuell hochlädst, wird das automatisch erzeugte Icon überschrieben.<br>Nach dem Upload wird der Dateiname des Bildes in Icon angezeigt. Solange noch kein Icon hochgeladen/automatisch generiert wurde, wird --- angezeigt.<br>Weitere Informationen findest Du im <a href="http://www. oxid-esales. com/de/resources/help-faq/eshop-manual/artikelbilder-grundlagen" target="_blank">Artikelbilder-Kapitel des Handbuchs</a>.',

'HELP_ARTICLE_PICTURES_THUMB'                 => 'Thumbnails sind kleine Bilder eines Artikels, sie werden z. B. in der in Artikellisten verwendet. <br>Wenn Du ein Thumbnail manuell hochlädst, wird das automatisch erzeugte Thumbnail überschrieben.<br>Nach dem Upload wird der Dateiname des Bildes in Thumbnail angezeigt. Solange noch kein Thumbnail hochgeladen/automatisch generiert wurde, wird --- angezeigt.<br>Weitere Informationen findest Du im <a href="http://www. oxid-esales. com/de/resources/help-faq/eshop-manual/artikelbilder-grundlagen" target="_blank">Artikelbilder-Kapitel des Handbuchs</a>.',

'HELP_ARTICLE_PICTURES_PIC1'                  => 'Artikelbilder werden in der Detailansicht eines Artikels verwendet. Du kannst bis zu 7 Artikelbilder pro Artikel hochladen. Nach dem Hochladen wird der Dateiname im jeweiligen Eingabefeld angezeigt. Wenn noch kein Bild hochgeladen wurde, wird --- angezeigt. <br>Es können Bilder mit maximal 2 MB oder 1500*1500 Pixel Auflösung hochgeladen werden. Diese Einschränkung gilt, um Probleme mit dem PHP-Speicherlimit zu vermeiden. Danach wird aus diesem Bild automatisch das Artikelbild, Zoombild, Thumbnail und Icon generiert.<br>Weitere Informationen findest Du im <a href="http://www. oxid-esales. com/de/resources/help-faq/eshop-manual/artikelbilder-grundlagen" target="_blank">Artikelbilder-Kapitel des Handbuchs</a>.',

'HELP_ARTICLE_PICTURES_ZOOM1'                 => 'Zoom-Bilder sind extra große Artikelbilder, die in der Detailansicht eines Artikels verlinkt werden. <br>Zoom-Bilder kannst Du bei <span class="navipath_or_inputname">Zoom X hochladen</span> hochladen. Bei <span class="navipath_or_inputname">Zoom X</span> wird nach dem Hochladen der Dateiname des Zoom-Bildes angezeigt, wenn noch kein Zoom-Bild hochgeladen wurde, wird <span class="userinput_or_code">nopic.jpg</span> angezeigt.<br>Weitere Informationen findest Du im <a href="http://www.oxid-esales.com/de/resources/help-faq/eshop-manual/artikelbilder-grundlagen" target="_blank">Artikelbilder-Kapitel des Handbuchs</a>.',
...
'HELP_ARTICLE_STOCK_AMOUNTPRICE_PRICE'        => 'Bei <span class="navipath_or_inputname">Preis </span>kannst Du den Preis für die eingegebene Menge einstellen. Du hast die Möglichkeit, den Preis absolut einzugeben oder prozentualen Rabatt einzurichten.<br> Weitere Informationen zu Staffelpreisen findest Du im <a href="http://www.oxid-esales.com/de/resources/help-faq/eshop-manual/staffelpreise-einrichten" target="_blank">Oxid eShop Handbuch</a>.',
...
'HELP_CATEGORY_MAIN_PARENTID'                 => 'Bei <span class="navipath_or_inputname">Unterkategorie von</span> stellst Du ein, an welcher Stelle die Kategorie erscheinen soll:<ul><li>Wenn die Kategorie keiner anderen Kategorie untergeordnet sein soll, dann wählst Du <span class="userinput_or_code">--</span> aus.</li><li>Wenn die Kategorie einer anderen Kategorie untergeordnet sein soll, dann wählst Du die entsprechende Kategorie aus.</li></ul>',
...
'HELP_DELIVERY_MAIN_COUNTRULES'               => 'Mit dieser Einstellung kannst Du auswählen, wie oft der Preis Auf-/Abschlag berechnet wird:<br><ul><li>Einmal pro Warenkorb: Der Preis wird einmal für die gesamte Bestellung berechnet.</li><li>Einmal pro unterschiedlichem Artikel: Der Preis wird für jeden unterschiedlichen Artikel im Warenkorb einmal berechnet. Wie oft ein Artikel bestellt wird, ist dabei egal.</li><li>Für jeden Artikel: Der Preis wird für jeden Artikel im Warenkorb berechnet.</li></ul>',

'HELP_DELIVERY_MAIN_CONDITION'                => 'Mit <span class="navipath_or_inputname">Bedingung</span> kannst Du einstellen, dass die Versandkostenregel nur für eine bestimmte Bedingung gültig ist. Du kannst zwischen 4 Bedingungen wählen:<br><ul><li>Menge: Anzahl aller Artikel im Warenkorb.</li><li>Größe: Die Gesamtgröße aller Artikel.</li><li>Gewicht: Das Gesamtgewicht der Bestellung in Kilogramm.</li><li>Preis: Der Einkaufswert der Bestellung.</li></ul>Mit den Eingabefeldern <span class="navipath_or_inputname">>=</span> (größer gleich) und <span class="navipath_or_inputname"><=</span> (kleiner gleich) kannst Du den Bereich einstellen, für den die Bedingung gültig sein soll. Bei <span class="navipath_or_inputname"><=</span> muss eine größere Zahl als bei <span class="navipath_or_inputname">>=</span> eingegeben werden.',

'HELP_DELIVERY_MAIN_PRICE'                    => 'Mit <span class="navipath_or_inputname">Preis Auf-/Abschlag</span> kannst Du eingeben, wie hoch die Versandkosten sind. Der Preis kann auf zwei verschiedene Arten berechnet werden:<ul><li>Mit <span class="userinput_or_code">abs</span> wird der Preis absolut angegeben (z. B.: Mit <span class="userinput_or_code">6,90</span> werden 6,90 Euro berechnet).</li><li>Mit <span class="userinput_or_code">%</span> wird der Preis relativ zum Einkaufswert angegeben (z. B.: Mit <span class="userinput_or_code">10</span> werden 10% des Einkaufswerts berechnet).</li></ul>',
...
'HELP_DISCOUNT_MAIN_SORT'                     => 'Mit <span class="navipath_or_inputname">Sortierung</span> kannst Du festlegen, in welcher Reihenfolge die Rabatte auf Artikel oder den Warenkorb angewendet werden. Der Rabatt mit der kleinsten Zahl wird zuerst angewendet, der mit der größten Zahl zuletzt.',
...
'HELP_DISCOUNT_MAIN_REBATE'                   => 'Bei <span class="navipath_or_inputname">Rabatt</span> stellst Du ein, wie hoch der Rabatt sein soll. Mit der Auswahlliste hinter dem Eingabefeld kannst Du auswählen, ob der Rabatt absolut oder prozentual sein soll:<ul><li><span class="userinput_or_code">abs</span>: Der Rabatt ist absolut, z. B. 5 Euro.</li><li><span class="userinput_or_code">%</span>: Der Rabatt ist prozentual, z. B. 10 Prozent vom Einkaufswert.</li>
<li><span class="userinput_or_code">itm</span>: Rabatt in Form eines kostenfreien Artikels (Dreingabe). Leg die Menge für diesen Artikel fest. Wähle "Multiplizieren", wenn die Menge des rabattierten Artikels im Warenkorb mit der Menge des kostenlosen Artikels multipliziert werden soll.</li>
</ul>',
...
'HELP_PAYMENT_MAIN_AMOUNT'                    => 'Mit <span class="navipath_or_inputname">Einkaufswert</span> kannst Du einstellen, dass die Zahlungsart nur für bestimmte Einkaufswerte gültig ist. Mit den Feldern <span class="navipath_or_inputname">von</span> und <span class="navipath_or_inputname">bis</span> kannst Du den Bereich einstellen.<br>Wenn die Zahlungsart für jeden Einkaufswert gültig sein soll, musst Du eine Bedingung eingeben, die immer gültig ist: Gib in das Feld <span class="navipath_or_inputname">von</span> <span class="userinput_or_code">0</span> ein, in das Feld <span class="navipath_or_inputname">bis</span> <span class="userinput_or_code">999999999</span>.',

'HELP_PAYMENT_MAIN_ADDPRICE'                  => 'Bei <span class="navipath_or_inputname">Preisauf-/abschlag</span> wird der Preis für die Zahlungsart eingegeben. Die Preise können auf zwei verschiedene Arten angegeben werden:<ul><li>Mit <span class="userinput_or_code">abs</span> wird der Preis absolut angegeben (z. B.: Wenn Du <span class="userinput_or_code">7,50</span> eingibst, werden 7,50 Euro berechnet).</li><li>Mit <span class="userinput_or_code">%</span> wird der Preis relativ zum Einkaufspreis berechnet (z. B.: Wenn Du <span class="userinput_or_code">2</span> eingibst, werden 2 Prozent des Einkaufspreises berechnet).</li></ul>Du kannst auch negative Werte eingeben. Dadurch wird der eingegebene Wert abgezogen: Wenn Du z. B. <span class="userinput_or_code">-2</span> eingibst und <span class="userinput_or_code">%</span> auswählen, werden 2% des Einkaufswerts abgezogen',
...
'HELP_USER_MAIN_HASPASSWORD'                  => 'Hier wird angezeigt, ob der Benutzer ein Passwort hat. Daran kannst Du unterscheiden, ob sich der Benutzer bei der Bestellung registriert hat:<ul><li>Wenn ein Passwort vorhanden ist, hat sich der Benutzer registriert.</li><li>Wenn kein Passwort vorhanden ist, hat der Benutzer bestellt ohne sich zu registrieren.</li></ul>',

'HELP_USER_PAYMENT_METHODS'                   => 'Auf dieser Registerkarte kannst Du:
<ul><li>Zahlungsarten des Benutzers anzeigen und verwalten.</li>
...
'HELP_VOUCHERSERIE_MAIN_DISCOUNT'             => 'Bei <span class="navipath_or_inputname">Rabatt</span> stellst Du ein, wie hoch der Rabatt des Gutscheins sein soll sein soll. Mit der Auswahlliste hinter dem Eingabefeld kannst Du auswählen, ob der Rabatt absolut oder prozentual sein soll:<ul><li><span class="userinput_or_code">abs</span>: Der Rabatt ist absolut, z. B. 5 Euro.</li><li><span class="userinput_or_code">%</span>: Der Rabatt ist prozentual, z. B. 10 Prozent vom Einkaufswert.</li></ul>',
...
'HELP_SHOP_CONFIG_FIELDS_CONTACTFORM'         => 'Hier kannst Du die Felder des Kontaktformulars festlegen, welche vom Benutzer unbedingt auszufüllen sind.',
];
