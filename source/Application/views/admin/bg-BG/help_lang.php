...
'HELP_SHOP_CONFIG_INVITATION'                 => 'С поканата можете да приканите приятелите си да посетят уебсайта ви, а вие получавате кредит под форма на точки за всяка покана.',
