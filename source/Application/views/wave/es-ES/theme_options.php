...
<a href="https://support.google.com/analytics/answer/1009612?hl=en&ref_topic=1037061" target="_blank">Link</a>',
    ...
    'SHOP_THEME_sLogoFile'                          => 'Nombre de archivo del logo',
    'HELP_SHOP_THEME_sLogoFile'                     => 'Esto esta relacionado con la dirección <code>/out/flow/img/</code>.',

    'SHOP_THEME_sLogoWidth'                         => 'Ancho del logo de encabezado',
    'HELP_SHOP_THEME_sLogoWidth'                    => '',
    'SHOP_THEME_sLogoHeight'                        => 'Altura del logo de encabezado',
    ...
    'SHOP_THEME_sBackgroundRepeat_repeat-y'         => 'Sí, vertical',
    'SHOP_THEME_sBackgroundRepeat_repeat'           => 'Sí, horizontal y vertical',
    ...
    'HELP_SHOP_THEME_sShoppingLanguage'             => 'Proporciona este campo sólo si envias datos a Google Shopping.<br><br>Idioma de la cuenta de Google Shopping. Este valor debe coincidir con el idioma de la cuenta que usas para envíar tu <a href="https://support.google.com/merchants/answer/188494#US" target="_blank">Datos de producto enviar a Google Shopping</a>.<br><br>El valor del parámetro de idioma debería ser un <a href="http://en.wikipedia.org/wiki/ISO_639-1" target="_blank">dos letras ISO 639-1 código de idioma</a>.<br><br>Por ejemplo, valores pueden ser en, fr, es, ja.',
