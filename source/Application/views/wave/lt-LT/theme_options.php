...
$aLang = array(
    ...
    'SHOP_THEME_sDefaultListDisplayType_line'       => 'Sąrašas',
    'SHOP_THEME_sDefaultListDisplayType_infogrid'   => 'Dvigubas tinklas',
    'SHOP_THEME_sStartPageListDisplayType'          => 'Produktų atvaizdavimo būdas pradiniame puslapyje',
    'SHOP_THEME_sStartPageListDisplayType_grid'     => 'Tinklelis',
    'SHOP_THEME_sStartPageListDisplayType_line'     => 'Sąrašas',
    'SHOP_THEME_sStartPageListDisplayType_infogrid' => 'Dvigubas tinklas',

    'SHOP_THEME_aNrofCatArticlesInGrid'             => 'Tinklelis: produktų sąraše (kategorijų puslapiuose, paieškos rezultatuose) rodomų produktų skaičius<br><br>Dėmesio: didelis produktų skaičius puslapyje (virš 100) gali atsiliepti greitaveikai!',
    'SHOP_THEME_aNrofCatArticles'                   => 'Tinklelis: produktų sąraše (kategorijų puslapiuose, paieškos rezultatuose) rodomų produktų skaičius<br><br>Dėmesio: didelis produktų skaičius puslapyje (virš 100) gali atsiliepti greitaveikai!',

    'SHOP_THEME_sFacebookUrl'                       => 'Facebook nuoroda',
    'HELP_SHOP_THEME_sFacebookUrl'                  => 'Pvz.: https://www.facebook.com/oxidesales',
    'SHOP_THEME_sTwitterUrl'                        => 'Twitter profilio nuoroda',
    'HELP_SHOP_THEME_sTwitterUrl'                   => 'Pvz.: https://twitter.com/OXID_eSales',
    'SHOP_THEME_sBlogUrl'                           => 'Blogo nuoroda',
    'HELP_SHOP_THEME_sBlogUrl'                      => 'Pvz.: http://blog.oxid-esales.com',
    'SHOP_THEME_sYouTubeUrl'                        => 'YouTube kanalo nuoroda',
    'HELP_SHOP_THEME_sYouTubeUrl'                   => 'Pvz.: https://www.youtube.com/user/oxidesales',
    'SHOP_THEME_sGooglePlusUrl'                     => 'Google+ puslapis',
    'HELP_SHOP_THEME_sGooglePlusUrl'                => 'Pvz.: https://plus.google.com/114133952363540971062',

    'SHOP_THEME_sGoogleMapsAddr'                    => 'Jūsų adresas',
    'HELP_SHOP_THEME_sGoogleMapsAddr'               => 'Pvz.: OXID eSales AG, Bertoldstraße 48, 79098 Freiburg',

    'SHOP_THEME_bl_showManufacturerSlider'          => 'Rodyti gamintojų karuselę pradiniame puslapyje',
    ...
    'HELP_SHOP_THEME_sLogoFile'                     => 'Kelias nuo <code>/out/wave/img/</code>.',

    'SHOP_THEME_sLogoWidth'                         => 'Antraštės logotipo plotis',
    'HELP_SHOP_THEME_sLogoWidth'                    => 'Nurodyti pikseliais.',
    'SHOP_THEME_sLogoHeight'                        => 'Logotipo antraštėje aukštis',
    'HELP_SHOP_THEME_sLogoHeight'                   => 'Nurodyti pikseliais.',

    'SHOP_THEME_sEmailLogo'                         => 'El. pašto antraštės logotipo failo pavadinimas',
    'HELP_SHOP_THEME_sEmailLogo'                    => 'Kelias nuo <code>/out/wave/img/</code>.',

    'SHOP_THEME_sFaviconFile'                       => 'Svetainės piktogramos failo pavadinimas',
    'HELP_SHOP_THEME_sFaviconFile'                  => 'Svetainės piktograma rodoma ant naršyklės auselės.<br>Paprastai tai ico failas<br>Kelias nuo <code>/out/wave/img/favicons/</code>.',
    'SHOP_THEME_sFavicon16File'                     => '16*16px piktogramos failo pavadinimas.',
    'SHOP_THEME_sFavicon32File'                     => '32*32px piktogramos failo pavadinimas.',
    'SHOP_THEME_sFavicon48File'                     => '48*48px piktogramos failo pavadinimas.',
    'SHOP_THEME_sFavicon64File'                     => '64*64px piktogramos failo pavadinimas.',
    'SHOP_THEME_sFavicon128File'                    => '128*128px piktogramos failo pavadinimas.',
    'SHOP_THEME_sFavicon512File'                    => '512*512px piktogramos failo pavadinimas.',
    'SHOP_THEME_sFaviconMSTileColor'                => 'Windows 8/Windows Mobile skirtuko(bookmark) laukelio spalva.',
    'HELP_SHOP_THEME_sFaviconMSTileColor'           => 'Nurodyti šešioliktainį kodą.<br>Pvz.: #D83434',

    'SHOP_THEME_blUseBackground'                    => 'Rodyti fono paveikslėlį',
    'SHOP_THEME_sBackgroundColor'                   => 'Parduotuvės fono spalva',
    'HELP_SHOP_THEME_sBackgroundColor'              => 'Nurodyti šešioliktainį kodą.<br>Pvz.: #D83434',
    'SHOP_THEME_sBackgroundPath'                    => 'Fono paveikslėlio failo pavadinimas',
    'HELP_SHOP_THEME_sBackgroundPath'               => 'Kelias nuo <code>/out/wave/img/backgrounds/</code>.',
    'SHOP_THEME_sBackgroundRepeat'                  => 'Atkartoti fono paveikslėlį?',
 ...
 produktų sąraše siunčiamame per Google Merchant center.</a> Jei turite MCA paskyrą, naudokite subaccount ID susietą su tuo produktų sąrašu.',
    ...
    'HELP_SHOP_THEME_sShoppingCountry'              => 'Pateikite lauką tik jei planuojate teikti duomenis į Google Shopping.<br><br>Paskyros šalis iš Google Shopping. Ši reikšmė turi sutapti su naudojamos paskyros šalimi tam, kad galėtumėte pateikti <a href="https://support.google.com/merchants/answer/188494#US" target="_blank">prekių duomenis į Google Shopping</a>.<br><br>Šalies parametro reikšmė turi būti <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" target="_blank">dvieju raidžių ISO 3166 šalies kodas</a>.<br><br>Pavyzdžiui, reikšmė gali būti US, GB, AU, FR, DE, JP.',
    'SHOP_THEME_sShoppingLanguage'                  => 'Google Shopping-Feed kalba (neprivaloma)',
    'HELP_SHOP_THEME_sShoppingLanguage'             => '',
    'SHOP_THEME_sShippingDaysOnStock'               => 'Dienų skaičius per kiek bus išsiųstas siuntinys, kuriame visos prekės yra sandėlyje.',
    'HELP_SHOP_THEME_sShippingDaysOnStock'          => '',
    'SHOP_THEME_sShippingDaysNotOnStock'            => 'Dienų skaičius per kiek bus išsiųstas siuntinys, kuriame <b>ne</b> visos prekės yra sandėlyje.',
    'HELP_SHOP_THEME_sShippingDaysNotOnStock'       => 'Numatoma data kada jūs išsiųsite užsakymą; tai nėra numatoma pristatymo data.<br><br> Jei užsakyme yra keletas prekių, pasirinkite vėliausią numatomą išsiuntimo datą.<br><br> Jei jūs pranešate klientui datų rėžį, rekomenduojame įtraukti vėliausią datą kaip datų rėžio galą. (pvz.: 7 dienos, jei jūsų pristatymo režis yra 5-7 dienos).<br><br>Data, kuri nurodyta čia, bus pateikta klientui el. paštu.<br><br>Klientas gaus paštu pirkimo įvertinimo anketą po numatytos pristatymo datos.',
    ...
    'SHOP_THEME_blSliderShowImageCaption'           => 'Pradinio puslapio karuselėse rodyti tekstą',
